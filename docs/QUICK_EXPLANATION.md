...
- **Unified CLI** — one command system every interface runs on (Serial, OLED, Web, Bluetooth, ESP-NOW, ESP-SR)
- **Serial interface** — serial-based control & monitoring over USB
- **Web interface** — browser-based control & monitoring over WiFi
- **OLED display interface** — on-device control & monitoring over I2C
- **G2 Glasses interface** — smartglasses-based control & monitoring over Bluetooth
- **Phone Bluetooth interface** — phone-based control & monitoring over Bluetooth
- **ESP-NOW command interface** — cross-device control & monitoring over ESP-NOW
- **ESP-SR voice interface** — on-device wake word + command recognition
