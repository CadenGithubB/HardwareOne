...
// =============================================================================
// Paged-text viewer core — MOVED to System_TextPager.h (2026-07-20)
// =============================================================================
// The wrap / split / nav core (TextPager, textWrapAppend/Into, textSplitPages,
// textNavPage) is pure string math shared by the G2 lens, the OLED file
// viewer, and serial fileview — it lives in System_TextPager.h now. This
// header keeps only the G2-side pieces: the list-page chrome above and the
// lens column constant below. The wire-facing render (g2TextPagerRender)
// stays in G2_Glasses.h.
