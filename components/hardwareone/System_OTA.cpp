...
const CommandEntry otaCommands[] = {
    ...
    {"otapin", "Unavailable without the opt-in OTA layout.", true,
     unavailable, nullptr, nullptr, nullptr, true},
