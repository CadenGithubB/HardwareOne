...
// Remote settings mode - displays and edits settings from paired peer device
...
// Apply a remote setting change by sending command to paired peer
// Returns true if command was sent successfully
bool applyRemoteSettingChange(const char* moduleName, const char* settingKey, const String& value);

// Check if remote settings are available (paired and cached)
