...
esp_err_t handleWaypointsPage(httpd_req_t* req) {
  ...
  httpd_resp_send_chunk(req,
    ...
    "    return;\n"
    "  }\n"
    "  hw.postForm('/api/waypoints', {action:'add', name:name, lat:lat, lon:lon})\n"
    ...
    "  hw.postForm('/api/waypoints', {action:'delete', index:idx})\n"
    "    .then(function(r) { return r.json(); })\n"
    "    .then(function(data) {\n"
    ...
    "  hw.postForm('/api/waypoints', {action:'goto', index:idx})\n"
    "    .then(function(r) { return r.json(); })\n"
    "    .then(function(data) {\n"
    "      if (data.success) loadWaypoints();\n"
    ...
    "  hw.postForm('/api/waypoints', {action:'clear'})\n"
    "    .then(function(r) { return r.json(); })\n"
    "    .then(function(data) {\n"
    "      if (data.success) loadWaypoints();\n"
