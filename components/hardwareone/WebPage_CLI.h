...
<div class='cli-container'>
  ...
  <div class='cli-input-container'>
    ...
    <input type='text' id='cli-input' class='cli-input' placeholder='Enter command...' autocomplete='one-time-code' data-1p-ignore data-lpignore='true' data-form-type='other'>
